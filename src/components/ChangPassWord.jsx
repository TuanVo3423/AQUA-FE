  ...
  return (
    ...
    <div className="col-span-3">
      ...
      <div className="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
        ...
        <div className="space-y-1 pl-8">
          ...
          <a href="change-password.html" className="hover:text-primary transition capitalize block text-primary">change password</a>
        </div>
        {/* single link end */}
        {/* single link */}
    ...
    <div className="col-span-9 shadow rounded px-6 pt-5 pb-7 mt-6 lg:mt-0">
      <form action>
        ...
        <div className="mt-6">
          <button type="submit" className="px-6 py-2 text-center text-white bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition uppercase font-roboto font-medium">
            Save change
          </button>
        </div>
      </form>
