...
export default function Banner() {
  ...
  return (
    <div onMouseOver={onHoverBanner} onMouseOut={onOutHoverBanner}>
      <Slider {...settings}>
        <div className="bg-cover bg-no-repeat bg-center py-36 relative bg-[url('../images/banner-01.png')]">
          <div className="container w-1/2">
            ...
            <p className="text-lg text-white leading-8 line-clamp-3">
              The e-commerce platform for every niche.Selling only the best
              things online.Ensuring the best welfare of the buyers and Helping
              buyers and sellers to attain their goals
            </p>
            <div className="mt-12">
              <Link
                to={"/shop"}
