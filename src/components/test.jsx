...
export default function DataDonation() {
    ...
    return (
        <div
            ref={myRef}
            style={{ backgroundImage: 'url(https://i.pinimg.com/564x/73/1e/8d/731e8da39fb57d27428bb19ce2b4ab42.jpg)' }}
            className="container bg-center bg-no-repeat bg-cover text-white"
        >
            <div style={{ maxWidth: '1170px' }} className="md:m-auto text-center md:mx-10 mx-0">
