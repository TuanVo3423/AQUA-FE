  ...
  return (
    <div>
        ...
        <div className="lg:w-10/12 grid md:grid-cols-3 gap-3 lg:gap-6 mx-auto justify-center">
            ...
            className={`${index === isHover ? 'bg-primary text-white border-primary' : 'bg-white text-primary border-primary'} transition-all duration-500 flex flex-col items-center px-6 py-9 justify-center gap-y-1 text-base font-normal border-[1px] rounded-3xl cursor-pointer`}>
                <p>{item.line1}</p>
                <p>{item.line2}</p>
            </div>
                )
