    ...
    <div>
            <div className="container flex justify-center mx-auto pt-16">
                <div>
                    ...
                    <h1 className="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the AQUA_VKU</h1>
                </div>
            </div>
            <div className="w-full bg-gray-100 px-10 pt-10">
                <div className="container mx-auto">
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                        {data.map((item,index) => (
                            <div className="w-[48%] relative mt-16 mb-32 sm:mb-24">
                                <div className="rounded overflow-hidden shadow-md bg-white">
                                    <div className="absolute -mt-20 w-full flex justify-center">
                                        <div className="h-32 w-32">
                                            <img src={item.img} alt='img' className="rounded-full object-cover h-full w-full shadow-md" />
                                        </div>
                                    </div>
                                    <div className="px-6 mt-16">
                                        <div className="font-bold text-[28px] text-center pb-1">{item.name}</div>
                                        <p className="text-gray-800 text-sm text-center">{item.role}</p>
                                        <p className="text-center text-gray-600 text-base pt-3 font-normal line-clamp-2">{item.des}</p>
